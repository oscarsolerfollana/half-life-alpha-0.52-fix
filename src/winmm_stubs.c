/* GENERATED by tools/gen_winmm.js: do not edit by hand.
 * One stub per export of the system winmm.dll: the first time it
 * resolves the real function (winmm_resolver, in loader.c) and jumps to it. */
